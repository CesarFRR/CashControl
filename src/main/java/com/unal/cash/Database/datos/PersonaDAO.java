...
public class PersonaDAO {
    ...
    public int insertar(Persona persona){
        ...
        try {
            ...
            stmt.setString(5, persona.getApellido());
            stmt.setString(6, persona.getEmail());
            stmt.setDouble(7, persona.getTelefono());
            stmt.setDouble(8, persona.getIngresosmensuales());
            stmt.setDouble(9, persona.getTransporte());
            stmt.setDouble(10, persona.getAlimentacion());
            stmt.setDouble(11, persona.getServicios());
            stmt.setDouble(12, persona.getEducacion());
            stmt.setDouble(13, persona.getEntretenimiento());
            stmt.setDouble(14, persona.getPersonal());
            stmt.setDouble(15, persona.getExcedentefindemes());
            stmt.setDouble(16, persona.getPerfilconsumo());
            stmt.setString(17, persona.getMetodopagomasusado());
